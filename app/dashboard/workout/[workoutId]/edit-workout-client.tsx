...
import { updateWorkoutAction, UpdateWorkoutWithExercisesInput } from '../new/actions'
...
export default function EditWorkoutClient({
  ...
  initialWorkout: WorkoutForm
}) {
  const router = useRouter()
  const [isSubmitting, setIsSubmitting] = useState(false)
  const [workoutName, setWorkoutName] = useState(initialWorkout.name)
  const [workoutDate, setWorkoutDate] = useState(initialWorkout.date)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const input: UpdateWorkoutWithExercisesInput = {
  ...
  return (
    <div className='min-h-screen bg-zinc-50 dark:bg-black'>
      <main className='mx-auto max-w-4xl p-4 sm:p-6'>
        <div className='mb-8'>
          <h2 className='text-2xl font-bold text-black dark:text-white'>Edit Workout</h2>
          <p className='text-gray-600 dark:text-gray-400'>Update your workout details</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <Card className='mb-6'>
            <CardHeader>
              ...
              <CardDescription>Update the basic information for your workout</CardDescription>
            </CardHeader>
