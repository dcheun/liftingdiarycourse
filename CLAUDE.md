...
All code generated by Claude Code should ALWAYS first refer to the relevant docs file within the `/docs` directory. When implementing features or making changes, please consult the documentation files in the docs directory to ensure consistency with project standards and requirements.
